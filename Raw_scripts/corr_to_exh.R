...
#edit
S_PT=readRDS("~/Documents/Projects/Data_files_temp/Donor/SAMPLE_NAME/Seurat.rds")
CH_PT=read.table("~/Documents/Projects/Data_files_temp/Donor/CH_ccrem_5BM_0.4/SAMPLE_NAME/input/CellClassification/SAMPLE_NAME-CellClassification.txt", header=T, sep="\t")
E_PT=read.table("~/Dropbox (Partners HealthCare)/More_BPDCN/AnalysisPeter/01_SignatureScores/SAMPLE_NAME_Texh.txt", header=T, sep="\t")
T_PT=read.csv("~/Dropbox (Partners HealthCare)/More_BPDCN/AnalysisMarina/SAMPLE_NAME_barcode_results.csv", header=T)
